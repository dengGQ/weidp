...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                               <span class="block m-t-xs"><strong class="font-bold">征信平台</strong></span>
                            </a>
                        </div>
                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <li>
                            ...
                            <li>
                                <a class="J_menuItem"  style = "color:red" >交易信息管理</a>
                            </li>
                        </ul>
                       ...
                       <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                             ...
                             <li>
                                <a class="J_menuItem" href="${webRoot}/customer/index">客户个人信息</a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                        	<li>
                                <a class="J_menuItem" href="${webRoot}/projectmanage/index">项目列表</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-right">&copy; 2017-2020 <a href="http://xxx/" target="_blank">征信平台</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
