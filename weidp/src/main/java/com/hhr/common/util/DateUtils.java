...
public class DateUtils {
    ...
    private static DateFormat monthfromat = null;
    ...
    static {
        ...
        monthfromat = new SimpleDateFormat(MONTH_DEFAULT_FORMAT);
    }
     ...
     * @return
     */
    public static Date getDateMonthFormat(String date) {
        try {
            return monthfromat.parse(date);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static String getLastDayOfMonthStr(Date date) {
        ...
        gregorianCalendar.add(Calendar.MONTH, 1);
        gregorianCalendar.add(Calendar.DAY_OF_MONTH, -1);
        return DateUtils.getDateFormat(gregorianCalendar.getTime());
    }
